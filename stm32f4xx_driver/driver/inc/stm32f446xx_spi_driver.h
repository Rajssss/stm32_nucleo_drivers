...
uint8_t SPIx_SendDataIT(SPIx_Handler_ty *pSPIhandler, uint8_t *pTxBuffer, uint32_t Length);	//SPI Interrupt based transmission
void SPIx_SendData(SPIx_RegDef_ty *pSPIx, uint8_t *pTxBuffer, uint32_t Length);
uint8_t SPIx_ReceiveDataIT(SPIx_Handler_ty *pSPIhandler, uint8_t *pRxBuffer, uint32_t Length); //SPI Interrupt based reception
...
//Other handlers
uint8_t SPIx_GetFlagStatus(SPIx_RegDef_ty *pSPIx, uint32_t Flag);	//Read Status Register of SPIx
