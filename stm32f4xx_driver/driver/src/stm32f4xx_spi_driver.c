 ...
 * @fn: 		- 	SPIx_SendDataIT
 *
 * @brief		-	This function configures various requirements of data transmission
 * 					of SPIx Peripheral. This is a SPI interrupt based Transmission.
 *
 ...
 * 					of SPIx Peripheral. This is a SPI interrupt based Reception.
 *
